...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const institutionLogin = async (email: string, password: string) => {
        ...
        const userData = {
            ...institution,
            institution: institution.orgName, // 🟢 Unify field name for context
            role: 'institution'
        };
        setToken(loginToken);
        setUser(userData);
    ...
    const authorityLogin = async (email: string, password: string) => {
        ...
        const userData = {
            ...
            institution: authority.institutionId, // Matches logic in controllers
            role: 'authority',
            authorityOrgId: authority.institutionId
        };
        setToken(loginToken);
        setUser(userData);
        localStorage.setItem('token', loginToken);
