          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/institution-transparency" element={<ProtectedRoute><InstitutionTransparency /></ProtectedRoute>} />
                ...
                <Route path="/report/:id" element={<ProtectedRoute><CaseReport /></ProtectedRoute>} />
